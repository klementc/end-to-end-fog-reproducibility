...
break;
    ...
    void return_1_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_1:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_1, put to 1_OBJECT_DETECT");
        s4u_Mailbox* m_1_OBJECT_DETECT = s4u_Mailbox::by_name("1_OBJECT_DETECT");
        m_1_OBJECT_DETECT->put(td, outSizes(td->requestType, "1_OBJECT_DETECT"));
...
break;
    ...
    void return_1_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_1:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT_ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_2_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_2:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_2, put to 2_OBJECT_DETECT");
        s4u_Mailbox* m_2_OBJECT_DETECT = s4u_Mailbox::by_name("2_OBJECT_DETECT");
        m_2_OBJECT_DETECT->put(td, outSizes(td->requestType, "2_OBJECT_DETECT"));
...
break;
    ...
    void return_2_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_2:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT__ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_3_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_3:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_3, put to 3_OBJECT_DETECT");
        s4u_Mailbox* m_3_OBJECT_DETECT = s4u_Mailbox::by_name("3_OBJECT_DETECT");
        m_3_OBJECT_DETECT->put(td, outSizes(td->requestType, "3_OBJECT_DETECT"));
...
break;
    ...
    void return_3_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_3:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT___ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_4_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_4:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_4, put to 4_OBJECT_DETECT");
        s4u_Mailbox* m_4_OBJECT_DETECT = s4u_Mailbox::by_name("4_OBJECT_DETECT");
        m_4_OBJECT_DETECT->put(td, outSizes(td->requestType, "4_OBJECT_DETECT"));
...
break;
    ...
    void return_4_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_4:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT____ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_5_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_5:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_5, put to 5_OBJECT_DETECT");
        s4u_Mailbox* m_5_OBJECT_DETECT = s4u_Mailbox::by_name("5_OBJECT_DETECT");
        m_5_OBJECT_DETECT->put(td, outSizes(td->requestType, "5_OBJECT_DETECT"));
...
break;
    ...
    void return_5_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_5:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT_____ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_6_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_6:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_6, put to 6_OBJECT_DETECT");
        s4u_Mailbox* m_6_OBJECT_DETECT = s4u_Mailbox::by_name("6_OBJECT_DETECT");
        m_6_OBJECT_DETECT->put(td, outSizes(td->requestType, "6_OBJECT_DETECT"));
...
break;
    ...
    void return_6_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_6:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT______ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_7_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_7:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_7, put to 7_OBJECT_DETECT");
        s4u_Mailbox* m_7_OBJECT_DETECT = s4u_Mailbox::by_name("7_OBJECT_DETECT");
        m_7_OBJECT_DETECT->put(td, outSizes(td->requestType, "7_OBJECT_DETECT"));
...
break;
    ...
    void return_7_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_7:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT_______ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_8_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_8:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_8, put to 8_OBJECT_DETECT");
        s4u_Mailbox* m_8_OBJECT_DETECT = s4u_Mailbox::by_name("8_OBJECT_DETECT");
        m_8_OBJECT_DETECT->put(td, outSizes(td->requestType, "8_OBJECT_DETECT"));
...
break;
    ...
    void return_8_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_8:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT________ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_9_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_9:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_9, put to 9_OBJECT_DETECT");
        s4u_Mailbox* m_9_OBJECT_DETECT = s4u_Mailbox::by_name("9_OBJECT_DETECT");
        m_9_OBJECT_DETECT->put(td, outSizes(td->requestType, "9_OBJECT_DETECT"));
...
break;
    ...
    void return_9_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_9:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT_________ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_10_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_10:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_10, put to 10_OBJECT_DETECT");
        s4u_Mailbox* m_10_OBJECT_DETECT = s4u_Mailbox::by_name("10_OBJECT_DETECT");
        m_10_OBJECT_DETECT->put(td, outSizes(td->requestType, "10_OBJECT_DETECT"));
...
break;
    ...
    void return_10_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_10:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT__________ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_11_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_11:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_11, put to 11_OBJECT_DETECT");
        s4u_Mailbox* m_11_OBJECT_DETECT = s4u_Mailbox::by_name("11_OBJECT_DETECT");
        m_11_OBJECT_DETECT->put(td, outSizes(td->requestType, "11_OBJECT_DETECT"));
...
break;
    ...
    void return_11_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_11:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT___________ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_12_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_12:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_12, put to 12_OBJECT_DETECT");
        s4u_Mailbox* m_12_OBJECT_DETECT = s4u_Mailbox::by_name("12_OBJECT_DETECT");
        m_12_OBJECT_DETECT->put(td, outSizes(td->requestType, "12_OBJECT_DETECT"));
...
break;
    ...
    void return_12_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_12:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT____________ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
break;
    ...
    void return_13_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_13:
      if (td->nbHops == 1) {
        XBT_DEBUG("Output Function for APP_13, put to 13_OBJECT_DETECT");
        s4u_Mailbox* m_13_OBJECT_DETECT = s4u_Mailbox::by_name("13_OBJECT_DETECT");
        m_13_OBJECT_DETECT->put(td, outSizes(td->requestType, "13_OBJECT_DETECT"));
...
break;
    ...
    void return_13_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType)
      {
case RequestType::APP_13:
      if (td->nbHops == 2) {
        XBT_DEBUG("Output Function for OBJECT_DETECT_____________ (PARALLEL CHILDS)");
        std::vector<simgrid::s4u::CommPtr> comV;
        simgrid::s4u::CommPtr com;
...
return -1;
    ...
    double pr_1_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_1:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_1_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_1:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_2_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_2:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_2_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_2:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_3_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_3:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_3_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_3:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_4_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_4:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_4_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_4:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_5_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_5:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_5_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_5:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_6_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_6:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_6_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_6:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_7_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_7:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_7_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_7:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_8_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_8:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_8_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_8:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_9_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_9:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_9_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_9:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_10_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_10:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_10_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_10:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_11_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_11:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_11_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_11:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_12_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_12:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_12_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_12:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
return -1;
    ...
    double pr_13_MOTION_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_13:
      if (td->nbHops == 1) {return 500000000/execR;}
      	}//it should never end up here
return -1;
    ...
    double pr_13_OBJECT_DETECT(sg_microserv::TaskDescription* td) {
      switch (td->requestType) {
case RequestType::APP_13:
      if (td->nbHops == 2) {return 250000000/execR;
}
...
std::string reqTypeToStr(RequestType t) {
  ...
  void run(std::map<std::string, std::vector<std::string>> configServices, std::map<std::string, std::vector<std::string>> elasticPools, std::vector<std::string> used_hosts) {
    ...
    // create ETM for service 1_MOTION_DETECT
    std::vector<std::string> v_serv_1_MOTION_DETECT = std::vector<std::string>();
    v_serv_1_MOTION_DETECT.push_back("1_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_1_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("1_MOTION_DETECT",v_serv_1_MOTION_DETECT);
    serviceToETM["1_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_1_MOTION_DETECT);
    serv_1_MOTION_DETECT->setBootDuration(0);
    // serv_1_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_1_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("1_MOTION_DETECT")->second.at(2)));
    serv_1_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_1_MOTION_DETECT->setExecRatio(std::stod(configServices.find("1_MOTION_DETECT")->second.at(1)));
    serv_1_MOTION_DETECT->setOutputFunction(return_1_MOTION_DETECT);
    serv_1_MOTION_DETECT->setExecAmountFunc(pr_1_MOTION_DETECT);
    serv_1_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_1_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("1_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_1_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("1_MOTION_DETECT")->second.at(0)), [serv_1_MOTION_DETECT] { serv_1_MOTION_DETECT->run(); });


    // create ETM for service 1_OBJECT_DETECT
    std::vector<std::string> v_serv_1_OBJECT_DETECT = std::vector<std::string>();
    v_serv_1_OBJECT_DETECT.push_back("1_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_1_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("1_OBJECT_DETECT",v_serv_1_OBJECT_DETECT);
    serviceToETM["1_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_1_OBJECT_DETECT);
    serv_1_OBJECT_DETECT->setBootDuration(0);
    // serv_1_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_1_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("1_OBJECT_DETECT")->second.at(2)));
    serv_1_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_1_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("1_OBJECT_DETECT")->second.at(1)));
    serv_1_OBJECT_DETECT->setOutputFunction(return_1_OBJECT_DETECT);
    serv_1_OBJECT_DETECT->setExecAmountFunc(pr_1_OBJECT_DETECT);
    serv_1_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_1_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("1_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_1_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("1_OBJECT_DETECT")->second.at(0)), [serv_1_OBJECT_DETECT] { serv_1_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 2_MOTION_DETECT
    std::vector<std::string> v_serv_2_MOTION_DETECT = std::vector<std::string>();
    v_serv_2_MOTION_DETECT.push_back("2_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_2_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("2_MOTION_DETECT",v_serv_2_MOTION_DETECT);
    serviceToETM["2_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_2_MOTION_DETECT);
    serv_2_MOTION_DETECT->setBootDuration(0);
    // serv_2_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_2_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("2_MOTION_DETECT")->second.at(2)));
    serv_2_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_2_MOTION_DETECT->setExecRatio(std::stod(configServices.find("2_MOTION_DETECT")->second.at(1)));
    serv_2_MOTION_DETECT->setOutputFunction(return_2_MOTION_DETECT);
    serv_2_MOTION_DETECT->setExecAmountFunc(pr_2_MOTION_DETECT);
    serv_2_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_2_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("2_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_2_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("2_MOTION_DETECT")->second.at(0)), [serv_2_MOTION_DETECT] { serv_2_MOTION_DETECT->run(); });


    // create ETM for service 2_OBJECT_DETECT
    std::vector<std::string> v_serv_2_OBJECT_DETECT = std::vector<std::string>();
    v_serv_2_OBJECT_DETECT.push_back("2_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_2_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("2_OBJECT_DETECT",v_serv_2_OBJECT_DETECT);
    serviceToETM["2_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_2_OBJECT_DETECT);
    serv_2_OBJECT_DETECT->setBootDuration(0);
    // serv_2_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_2_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("2_OBJECT_DETECT")->second.at(2)));
    serv_2_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_2_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("2_OBJECT_DETECT")->second.at(1)));
    serv_2_OBJECT_DETECT->setOutputFunction(return_2_OBJECT_DETECT);
    serv_2_OBJECT_DETECT->setExecAmountFunc(pr_2_OBJECT_DETECT);
    serv_2_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_2_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("2_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_2_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("2_OBJECT_DETECT")->second.at(0)), [serv_2_OBJECT_DETECT] { serv_2_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 3_MOTION_DETECT
    std::vector<std::string> v_serv_3_MOTION_DETECT = std::vector<std::string>();
    v_serv_3_MOTION_DETECT.push_back("3_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_3_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("3_MOTION_DETECT",v_serv_3_MOTION_DETECT);
    serviceToETM["3_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_3_MOTION_DETECT);
    serv_3_MOTION_DETECT->setBootDuration(0);
    // serv_3_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_3_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("3_MOTION_DETECT")->second.at(2)));
    serv_3_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_3_MOTION_DETECT->setExecRatio(std::stod(configServices.find("3_MOTION_DETECT")->second.at(1)));
    serv_3_MOTION_DETECT->setOutputFunction(return_3_MOTION_DETECT);
    serv_3_MOTION_DETECT->setExecAmountFunc(pr_3_MOTION_DETECT);
    serv_3_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_3_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("3_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_3_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("3_MOTION_DETECT")->second.at(0)), [serv_3_MOTION_DETECT] { serv_3_MOTION_DETECT->run(); });


    // create ETM for service 3_OBJECT_DETECT
    std::vector<std::string> v_serv_3_OBJECT_DETECT = std::vector<std::string>();
    v_serv_3_OBJECT_DETECT.push_back("3_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_3_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("3_OBJECT_DETECT",v_serv_3_OBJECT_DETECT);
    serviceToETM["3_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_3_OBJECT_DETECT);
    serv_3_OBJECT_DETECT->setBootDuration(0);
    // serv_3_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_3_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("3_OBJECT_DETECT")->second.at(2)));
    serv_3_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_3_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("3_OBJECT_DETECT")->second.at(1)));
    serv_3_OBJECT_DETECT->setOutputFunction(return_3_OBJECT_DETECT);
    serv_3_OBJECT_DETECT->setExecAmountFunc(pr_3_OBJECT_DETECT);
    serv_3_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_3_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("3_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_3_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("3_OBJECT_DETECT")->second.at(0)), [serv_3_OBJECT_DETECT] { serv_3_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 4_MOTION_DETECT
    std::vector<std::string> v_serv_4_MOTION_DETECT = std::vector<std::string>();
    v_serv_4_MOTION_DETECT.push_back("4_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_4_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("4_MOTION_DETECT",v_serv_4_MOTION_DETECT);
    serviceToETM["4_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_4_MOTION_DETECT);
    serv_4_MOTION_DETECT->setBootDuration(0);
    // serv_4_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_4_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("4_MOTION_DETECT")->second.at(2)));
    serv_4_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_4_MOTION_DETECT->setExecRatio(std::stod(configServices.find("4_MOTION_DETECT")->second.at(1)));
    serv_4_MOTION_DETECT->setOutputFunction(return_4_MOTION_DETECT);
    serv_4_MOTION_DETECT->setExecAmountFunc(pr_4_MOTION_DETECT);
    serv_4_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_4_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("4_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_4_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("4_MOTION_DETECT")->second.at(0)), [serv_4_MOTION_DETECT] { serv_4_MOTION_DETECT->run(); });


    // create ETM for service 4_OBJECT_DETECT
    std::vector<std::string> v_serv_4_OBJECT_DETECT = std::vector<std::string>();
    v_serv_4_OBJECT_DETECT.push_back("4_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_4_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("4_OBJECT_DETECT",v_serv_4_OBJECT_DETECT);
    serviceToETM["4_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_4_OBJECT_DETECT);
    serv_4_OBJECT_DETECT->setBootDuration(0);
    // serv_4_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_4_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("4_OBJECT_DETECT")->second.at(2)));
    serv_4_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_4_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("4_OBJECT_DETECT")->second.at(1)));
    serv_4_OBJECT_DETECT->setOutputFunction(return_4_OBJECT_DETECT);
    serv_4_OBJECT_DETECT->setExecAmountFunc(pr_4_OBJECT_DETECT);
    serv_4_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_4_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("4_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_4_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("4_OBJECT_DETECT")->second.at(0)), [serv_4_OBJECT_DETECT] { serv_4_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 5_MOTION_DETECT
    std::vector<std::string> v_serv_5_MOTION_DETECT = std::vector<std::string>();
    v_serv_5_MOTION_DETECT.push_back("5_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_5_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("5_MOTION_DETECT",v_serv_5_MOTION_DETECT);
    serviceToETM["5_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_5_MOTION_DETECT);
    serv_5_MOTION_DETECT->setBootDuration(0);
    // serv_5_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_5_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("5_MOTION_DETECT")->second.at(2)));
    serv_5_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_5_MOTION_DETECT->setExecRatio(std::stod(configServices.find("5_MOTION_DETECT")->second.at(1)));
    serv_5_MOTION_DETECT->setOutputFunction(return_5_MOTION_DETECT);
    serv_5_MOTION_DETECT->setExecAmountFunc(pr_5_MOTION_DETECT);
    serv_5_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_5_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("5_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_5_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("5_MOTION_DETECT")->second.at(0)), [serv_5_MOTION_DETECT] { serv_5_MOTION_DETECT->run(); });


    // create ETM for service 5_OBJECT_DETECT
    std::vector<std::string> v_serv_5_OBJECT_DETECT = std::vector<std::string>();
    v_serv_5_OBJECT_DETECT.push_back("5_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_5_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("5_OBJECT_DETECT",v_serv_5_OBJECT_DETECT);
    serviceToETM["5_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_5_OBJECT_DETECT);
    serv_5_OBJECT_DETECT->setBootDuration(0);
    // serv_5_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_5_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("5_OBJECT_DETECT")->second.at(2)));
    serv_5_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_5_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("5_OBJECT_DETECT")->second.at(1)));
    serv_5_OBJECT_DETECT->setOutputFunction(return_5_OBJECT_DETECT);
    serv_5_OBJECT_DETECT->setExecAmountFunc(pr_5_OBJECT_DETECT);
    serv_5_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_5_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("5_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_5_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("5_OBJECT_DETECT")->second.at(0)), [serv_5_OBJECT_DETECT] { serv_5_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 6_MOTION_DETECT
    std::vector<std::string> v_serv_6_MOTION_DETECT = std::vector<std::string>();
    v_serv_6_MOTION_DETECT.push_back("6_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_6_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("6_MOTION_DETECT",v_serv_6_MOTION_DETECT);
    serviceToETM["6_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_6_MOTION_DETECT);
    serv_6_MOTION_DETECT->setBootDuration(0);
    // serv_6_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_6_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("6_MOTION_DETECT")->second.at(2)));
    serv_6_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_6_MOTION_DETECT->setExecRatio(std::stod(configServices.find("6_MOTION_DETECT")->second.at(1)));
    serv_6_MOTION_DETECT->setOutputFunction(return_6_MOTION_DETECT);
    serv_6_MOTION_DETECT->setExecAmountFunc(pr_6_MOTION_DETECT);
    serv_6_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_6_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("6_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_6_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("6_MOTION_DETECT")->second.at(0)), [serv_6_MOTION_DETECT] { serv_6_MOTION_DETECT->run(); });


    // create ETM for service 6_OBJECT_DETECT
    std::vector<std::string> v_serv_6_OBJECT_DETECT = std::vector<std::string>();
    v_serv_6_OBJECT_DETECT.push_back("6_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_6_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("6_OBJECT_DETECT",v_serv_6_OBJECT_DETECT);
    serviceToETM["6_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_6_OBJECT_DETECT);
    serv_6_OBJECT_DETECT->setBootDuration(0);
    // serv_6_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_6_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("6_OBJECT_DETECT")->second.at(2)));
    serv_6_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_6_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("6_OBJECT_DETECT")->second.at(1)));
    serv_6_OBJECT_DETECT->setOutputFunction(return_6_OBJECT_DETECT);
    serv_6_OBJECT_DETECT->setExecAmountFunc(pr_6_OBJECT_DETECT);
    serv_6_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_6_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("6_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_6_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("6_OBJECT_DETECT")->second.at(0)), [serv_6_OBJECT_DETECT] { serv_6_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 7_MOTION_DETECT
    std::vector<std::string> v_serv_7_MOTION_DETECT = std::vector<std::string>();
    v_serv_7_MOTION_DETECT.push_back("7_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_7_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("7_MOTION_DETECT",v_serv_7_MOTION_DETECT);
    serviceToETM["7_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_7_MOTION_DETECT);
    serv_7_MOTION_DETECT->setBootDuration(0);
    // serv_7_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_7_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("7_MOTION_DETECT")->second.at(2)));
    serv_7_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_7_MOTION_DETECT->setExecRatio(std::stod(configServices.find("7_MOTION_DETECT")->second.at(1)));
    serv_7_MOTION_DETECT->setOutputFunction(return_7_MOTION_DETECT);
    serv_7_MOTION_DETECT->setExecAmountFunc(pr_7_MOTION_DETECT);
    serv_7_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_7_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("7_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_7_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("7_MOTION_DETECT")->second.at(0)), [serv_7_MOTION_DETECT] { serv_7_MOTION_DETECT->run(); });


    // create ETM for service 7_OBJECT_DETECT
    std::vector<std::string> v_serv_7_OBJECT_DETECT = std::vector<std::string>();
    v_serv_7_OBJECT_DETECT.push_back("7_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_7_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("7_OBJECT_DETECT",v_serv_7_OBJECT_DETECT);
    serviceToETM["7_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_7_OBJECT_DETECT);
    serv_7_OBJECT_DETECT->setBootDuration(0);
    // serv_7_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_7_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("7_OBJECT_DETECT")->second.at(2)));
    serv_7_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_7_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("7_OBJECT_DETECT")->second.at(1)));
    serv_7_OBJECT_DETECT->setOutputFunction(return_7_OBJECT_DETECT);
    serv_7_OBJECT_DETECT->setExecAmountFunc(pr_7_OBJECT_DETECT);
    serv_7_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_7_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("7_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_7_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("7_OBJECT_DETECT")->second.at(0)), [serv_7_OBJECT_DETECT] { serv_7_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 8_MOTION_DETECT
    std::vector<std::string> v_serv_8_MOTION_DETECT = std::vector<std::string>();
    v_serv_8_MOTION_DETECT.push_back("8_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_8_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("8_MOTION_DETECT",v_serv_8_MOTION_DETECT);
    serviceToETM["8_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_8_MOTION_DETECT);
    serv_8_MOTION_DETECT->setBootDuration(0);
    // serv_8_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_8_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("8_MOTION_DETECT")->second.at(2)));
    serv_8_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_8_MOTION_DETECT->setExecRatio(std::stod(configServices.find("8_MOTION_DETECT")->second.at(1)));
    serv_8_MOTION_DETECT->setOutputFunction(return_8_MOTION_DETECT);
    serv_8_MOTION_DETECT->setExecAmountFunc(pr_8_MOTION_DETECT);
    serv_8_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_8_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("8_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_8_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("8_MOTION_DETECT")->second.at(0)), [serv_8_MOTION_DETECT] { serv_8_MOTION_DETECT->run(); });


    // create ETM for service 8_OBJECT_DETECT
    std::vector<std::string> v_serv_8_OBJECT_DETECT = std::vector<std::string>();
    v_serv_8_OBJECT_DETECT.push_back("8_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_8_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("8_OBJECT_DETECT",v_serv_8_OBJECT_DETECT);
    serviceToETM["8_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_8_OBJECT_DETECT);
    serv_8_OBJECT_DETECT->setBootDuration(0);
    // serv_8_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_8_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("8_OBJECT_DETECT")->second.at(2)));
    serv_8_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_8_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("8_OBJECT_DETECT")->second.at(1)));
    serv_8_OBJECT_DETECT->setOutputFunction(return_8_OBJECT_DETECT);
    serv_8_OBJECT_DETECT->setExecAmountFunc(pr_8_OBJECT_DETECT);
    serv_8_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_8_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("8_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_8_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("8_OBJECT_DETECT")->second.at(0)), [serv_8_OBJECT_DETECT] { serv_8_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 9_MOTION_DETECT
    std::vector<std::string> v_serv_9_MOTION_DETECT = std::vector<std::string>();
    v_serv_9_MOTION_DETECT.push_back("9_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_9_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("9_MOTION_DETECT",v_serv_9_MOTION_DETECT);
    serviceToETM["9_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_9_MOTION_DETECT);
    serv_9_MOTION_DETECT->setBootDuration(0);
    // serv_9_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_9_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("9_MOTION_DETECT")->second.at(2)));
    serv_9_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_9_MOTION_DETECT->setExecRatio(std::stod(configServices.find("9_MOTION_DETECT")->second.at(1)));
    serv_9_MOTION_DETECT->setOutputFunction(return_9_MOTION_DETECT);
    serv_9_MOTION_DETECT->setExecAmountFunc(pr_9_MOTION_DETECT);
    serv_9_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_9_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("9_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_9_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("9_MOTION_DETECT")->second.at(0)), [serv_9_MOTION_DETECT] { serv_9_MOTION_DETECT->run(); });


    // create ETM for service 9_OBJECT_DETECT
    std::vector<std::string> v_serv_9_OBJECT_DETECT = std::vector<std::string>();
    v_serv_9_OBJECT_DETECT.push_back("9_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_9_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("9_OBJECT_DETECT",v_serv_9_OBJECT_DETECT);
    serviceToETM["9_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_9_OBJECT_DETECT);
    serv_9_OBJECT_DETECT->setBootDuration(0);
    // serv_9_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_9_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("9_OBJECT_DETECT")->second.at(2)));
    serv_9_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_9_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("9_OBJECT_DETECT")->second.at(1)));
    serv_9_OBJECT_DETECT->setOutputFunction(return_9_OBJECT_DETECT);
    serv_9_OBJECT_DETECT->setExecAmountFunc(pr_9_OBJECT_DETECT);
    serv_9_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_9_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("9_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_9_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("9_OBJECT_DETECT")->second.at(0)), [serv_9_OBJECT_DETECT] { serv_9_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 10_MOTION_DETECT
    std::vector<std::string> v_serv_10_MOTION_DETECT = std::vector<std::string>();
    v_serv_10_MOTION_DETECT.push_back("10_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_10_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("10_MOTION_DETECT",v_serv_10_MOTION_DETECT);
    serviceToETM["10_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_10_MOTION_DETECT);
    serv_10_MOTION_DETECT->setBootDuration(0);
    // serv_10_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_10_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("10_MOTION_DETECT")->second.at(2)));
    serv_10_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_10_MOTION_DETECT->setExecRatio(std::stod(configServices.find("10_MOTION_DETECT")->second.at(1)));
    serv_10_MOTION_DETECT->setOutputFunction(return_10_MOTION_DETECT);
    serv_10_MOTION_DETECT->setExecAmountFunc(pr_10_MOTION_DETECT);
    serv_10_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_10_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("10_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_10_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("10_MOTION_DETECT")->second.at(0)), [serv_10_MOTION_DETECT] { serv_10_MOTION_DETECT->run(); });


    // create ETM for service 10_OBJECT_DETECT
    std::vector<std::string> v_serv_10_OBJECT_DETECT = std::vector<std::string>();
    v_serv_10_OBJECT_DETECT.push_back("10_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_10_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("10_OBJECT_DETECT",v_serv_10_OBJECT_DETECT);
    serviceToETM["10_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_10_OBJECT_DETECT);
    serv_10_OBJECT_DETECT->setBootDuration(0);
    // serv_10_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_10_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("10_OBJECT_DETECT")->second.at(2)));
    serv_10_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_10_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("10_OBJECT_DETECT")->second.at(1)));
    serv_10_OBJECT_DETECT->setOutputFunction(return_10_OBJECT_DETECT);
    serv_10_OBJECT_DETECT->setExecAmountFunc(pr_10_OBJECT_DETECT);
    serv_10_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_10_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("10_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_10_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("10_OBJECT_DETECT")->second.at(0)), [serv_10_OBJECT_DETECT] { serv_10_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 11_MOTION_DETECT
    std::vector<std::string> v_serv_11_MOTION_DETECT = std::vector<std::string>();
    v_serv_11_MOTION_DETECT.push_back("11_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_11_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("11_MOTION_DETECT",v_serv_11_MOTION_DETECT);
    serviceToETM["11_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_11_MOTION_DETECT);
    serv_11_MOTION_DETECT->setBootDuration(0);
    // serv_11_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_11_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("11_MOTION_DETECT")->second.at(2)));
    serv_11_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_11_MOTION_DETECT->setExecRatio(std::stod(configServices.find("11_MOTION_DETECT")->second.at(1)));
    serv_11_MOTION_DETECT->setOutputFunction(return_11_MOTION_DETECT);
    serv_11_MOTION_DETECT->setExecAmountFunc(pr_11_MOTION_DETECT);
    serv_11_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_11_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("11_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_11_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("11_MOTION_DETECT")->second.at(0)), [serv_11_MOTION_DETECT] { serv_11_MOTION_DETECT->run(); });


    // create ETM for service 11_OBJECT_DETECT
    std::vector<std::string> v_serv_11_OBJECT_DETECT = std::vector<std::string>();
    v_serv_11_OBJECT_DETECT.push_back("11_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_11_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("11_OBJECT_DETECT",v_serv_11_OBJECT_DETECT);
    serviceToETM["11_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_11_OBJECT_DETECT);
    serv_11_OBJECT_DETECT->setBootDuration(0);
    // serv_11_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_11_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("11_OBJECT_DETECT")->second.at(2)));
    serv_11_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_11_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("11_OBJECT_DETECT")->second.at(1)));
    serv_11_OBJECT_DETECT->setOutputFunction(return_11_OBJECT_DETECT);
    serv_11_OBJECT_DETECT->setExecAmountFunc(pr_11_OBJECT_DETECT);
    serv_11_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_11_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("11_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_11_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("11_OBJECT_DETECT")->second.at(0)), [serv_11_OBJECT_DETECT] { serv_11_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 12_MOTION_DETECT
    std::vector<std::string> v_serv_12_MOTION_DETECT = std::vector<std::string>();
    v_serv_12_MOTION_DETECT.push_back("12_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_12_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("12_MOTION_DETECT",v_serv_12_MOTION_DETECT);
    serviceToETM["12_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_12_MOTION_DETECT);
    serv_12_MOTION_DETECT->setBootDuration(0);
    // serv_12_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_12_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("12_MOTION_DETECT")->second.at(2)));
    serv_12_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_12_MOTION_DETECT->setExecRatio(std::stod(configServices.find("12_MOTION_DETECT")->second.at(1)));
    serv_12_MOTION_DETECT->setOutputFunction(return_12_MOTION_DETECT);
    serv_12_MOTION_DETECT->setExecAmountFunc(pr_12_MOTION_DETECT);
    serv_12_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_12_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("12_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_12_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("12_MOTION_DETECT")->second.at(0)), [serv_12_MOTION_DETECT] { serv_12_MOTION_DETECT->run(); });


    // create ETM for service 12_OBJECT_DETECT
    std::vector<std::string> v_serv_12_OBJECT_DETECT = std::vector<std::string>();
    v_serv_12_OBJECT_DETECT.push_back("12_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_12_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("12_OBJECT_DETECT",v_serv_12_OBJECT_DETECT);
    serviceToETM["12_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_12_OBJECT_DETECT);
    serv_12_OBJECT_DETECT->setBootDuration(0);
    // serv_12_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_12_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("12_OBJECT_DETECT")->second.at(2)));
    serv_12_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_12_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("12_OBJECT_DETECT")->second.at(1)));
    serv_12_OBJECT_DETECT->setOutputFunction(return_12_OBJECT_DETECT);
    serv_12_OBJECT_DETECT->setExecAmountFunc(pr_12_OBJECT_DETECT);
    serv_12_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_12_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("12_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_12_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("12_OBJECT_DETECT")->second.at(0)), [serv_12_OBJECT_DETECT] { serv_12_OBJECT_DETECT->run(); });
    ...
    // create ETM for service 13_MOTION_DETECT
    std::vector<std::string> v_serv_13_MOTION_DETECT = std::vector<std::string>();
    v_serv_13_MOTION_DETECT.push_back("13_MOTION_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_13_MOTION_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("13_MOTION_DETECT",v_serv_13_MOTION_DETECT);
    serviceToETM["13_MOTION_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_13_MOTION_DETECT);
    serv_13_MOTION_DETECT->setBootDuration(0);
    // serv_13_MOTION_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_13_MOTION_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("13_MOTION_DETECT")->second.at(2)));
    serv_13_MOTION_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_13_MOTION_DETECT->setExecRatio(std::stod(configServices.find("13_MOTION_DETECT")->second.at(1)));
    serv_13_MOTION_DETECT->setOutputFunction(return_13_MOTION_DETECT);
    serv_13_MOTION_DETECT->setExecAmountFunc(pr_13_MOTION_DETECT);
    serv_13_MOTION_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_13_MOTION_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("13_MOTION_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_13_MOTION_DETECT", simgrid::s4u::Host::by_name(configServices.find("13_MOTION_DETECT")->second.at(0)), [serv_13_MOTION_DETECT] { serv_13_MOTION_DETECT->run(); });


    // create ETM for service 13_OBJECT_DETECT
    std::vector<std::string> v_serv_13_OBJECT_DETECT = std::vector<std::string>();
    v_serv_13_OBJECT_DETECT.push_back("13_OBJECT_DETECT");
    std::shared_ptr<sg_microserv::ElasticTaskManager> serv_13_OBJECT_DETECT = std::make_shared<sg_microserv::ElasticTaskManager>("13_OBJECT_DETECT",v_serv_13_OBJECT_DETECT);
    serviceToETM["13_OBJECT_DETECT"] = std::shared_ptr<sg_microserv::ElasticTaskManager>(serv_13_OBJECT_DETECT);
    serv_13_OBJECT_DETECT->setBootDuration(0);
    // serv_13_OBJECT_DETECT->setDataSizeRatio(1); NOT USED ANYMORE, KEEP AS COMMENT IN CASE
    // modify this value in the configuration file (parDeg)
    serv_13_OBJECT_DETECT->setParallelTasksPerInst(std::stoi(configServices.find("13_OBJECT_DETECT")->second.at(2)));
    serv_13_OBJECT_DETECT->setParallelRecPerETM(32);
    // modify this value in the  configuration file (execRatio)
    serv_13_OBJECT_DETECT->setExecRatio(std::stod(configServices.find("13_OBJECT_DETECT")->second.at(1)));
    serv_13_OBJECT_DETECT->setOutputFunction(return_13_OBJECT_DETECT);
    serv_13_OBJECT_DETECT->setExecAmountFunc(pr_13_OBJECT_DETECT);
    serv_13_OBJECT_DETECT->setReqNames(reqTypeToStr);
    // set the host location in the config file (location)
    serv_13_OBJECT_DETECT->addHost(simgrid::s4u::Host::by_name(configServices.find("13_OBJECT_DETECT")->second.at(0)));
    simgrid::s4u::Actor::create("etm_13_OBJECT_DETECT", simgrid::s4u::Host::by_name(configServices.find("13_OBJECT_DETECT")->second.at(0)), [serv_13_OBJECT_DETECT] { serv_13_OBJECT_DETECT->run(); });
...
std::vector<simgrid::s4u::ActorPtr> placedDS;
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("1_MOTION_DETECT",RequestType::APP_1, 1./1, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_16"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("1_MOTION_DETECT",RequestType::APP_1, 1./4, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_17"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("1_MOTION_DETECT",RequestType::APP_1, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_18"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("1_MOTION_DETECT",RequestType::APP_1, 1./2, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_19"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("1_MOTION_DETECT",RequestType::APP_1, 1./5, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("2_MOTION_DETECT",RequestType::APP_2, 1./5, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_32"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("2_MOTION_DETECT",RequestType::APP_2, 1./2, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_33"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("2_MOTION_DETECT",RequestType::APP_2, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("2_MOTION_DETECT",RequestType::APP_2, 1./3, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("2_MOTION_DETECT",RequestType::APP_2, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("3_MOTION_DETECT",RequestType::APP_3, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_48"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("3_MOTION_DETECT",RequestType::APP_3, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("3_MOTION_DETECT",RequestType::APP_3, 1./5, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_51"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("3_MOTION_DETECT",RequestType::APP_3, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("3_MOTION_DETECT",RequestType::APP_3, 1./2, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("4_MOTION_DETECT",RequestType::APP_4, 1./2, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_64"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("4_MOTION_DETECT",RequestType::APP_4, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("4_MOTION_DETECT",RequestType::APP_4, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_68"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("4_MOTION_DETECT",RequestType::APP_4, 1./5, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("4_MOTION_DETECT",RequestType::APP_4, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("5_MOTION_DETECT",RequestType::APP_5, 1./1, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_80"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("5_MOTION_DETECT",RequestType::APP_5, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("5_MOTION_DETECT",RequestType::APP_5, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_83"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("5_MOTION_DETECT",RequestType::APP_5, 1./5, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("5_MOTION_DETECT",RequestType::APP_5, 1./2, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("6_MOTION_DETECT",RequestType::APP_6, 1./2, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_96"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("6_MOTION_DETECT",RequestType::APP_6, 1./4, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_97"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("6_MOTION_DETECT",RequestType::APP_6, 1./5, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_98"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("6_MOTION_DETECT",RequestType::APP_6, 1./3, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("6_MOTION_DETECT",RequestType::APP_6, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("7_MOTION_DETECT",RequestType::APP_7, 1./2, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_112"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("7_MOTION_DETECT",RequestType::APP_7, 1./4, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_113"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("7_MOTION_DETECT",RequestType::APP_7, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("7_MOTION_DETECT",RequestType::APP_7, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_116"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("7_MOTION_DETECT",RequestType::APP_7, 1./5, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("8_MOTION_DETECT",RequestType::APP_8, 1./5, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("8_MOTION_DETECT",RequestType::APP_8, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_131"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("8_MOTION_DETECT",RequestType::APP_8, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("8_MOTION_DETECT",RequestType::APP_8, 1./1, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_134"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("8_MOTION_DETECT",RequestType::APP_8, 1./2, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("9_MOTION_DETECT",RequestType::APP_9, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("9_MOTION_DETECT",RequestType::APP_9, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("9_MOTION_DETECT",RequestType::APP_9, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_149"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("9_MOTION_DETECT",RequestType::APP_9, 1./2, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("9_MOTION_DETECT",RequestType::APP_9, 1./5, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("10_MOTION_DETECT",RequestType::APP_10, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_160"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("10_MOTION_DETECT",RequestType::APP_10, 1./5, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_161"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("10_MOTION_DETECT",RequestType::APP_10, 1./2, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("10_MOTION_DETECT",RequestType::APP_10, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("10_MOTION_DETECT",RequestType::APP_10, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("11_MOTION_DETECT",RequestType::APP_11, 1./3, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_176"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("11_MOTION_DETECT",RequestType::APP_11, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("11_MOTION_DETECT",RequestType::APP_11, 1./5, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_179"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("11_MOTION_DETECT",RequestType::APP_11, 1./2, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("11_MOTION_DETECT",RequestType::APP_11, 1./4, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("12_MOTION_DETECT",RequestType::APP_12, 1./4, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_192"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("12_MOTION_DETECT",RequestType::APP_12, 1./5, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_193"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("12_MOTION_DETECT",RequestType::APP_12, 1./2, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("12_MOTION_DETECT",RequestType::APP_12, 1./1, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("12_MOTION_DETECT",RequestType::APP_12, 1./3, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("13_MOTION_DETECT",RequestType::APP_13, 1./1, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_208"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("13_MOTION_DETECT",RequestType::APP_13, 1./3, sizeR);
      ...
      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("13_MOTION_DETECT",RequestType::APP_13, 1./2, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_214"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("13_MOTION_DETECT",RequestType::APP_13, 1./4, sizeR);
      simgrid::s4u::ActorPtr dataS = simgrid::s4u::Actor::create("snd", simgrid::s4u::Host::by_name("STA_215"), [&]{dsf->run();});
      placedDS.push_back(dataS);}

      {sg_microserv::DataSourceFixedInterval* dsf = new sg_microserv::DataSourceFixedInterval("13_MOTION_DETECT",RequestType::APP_13, 1./5, sizeR);
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_1_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_1_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_2_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_2_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_3_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_3_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_4_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_4_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_5_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_5_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_6_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_6_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_7_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_7_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_8_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_8_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_9_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_9_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_10_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_10_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_11_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_11_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_12_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_12_OBJECT_DETECT->kill();});
  ...
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_13_MOTION_DETECT->kill();});
  simgrid::s4u::Actor::create("k", simgrid::s4u::Host::by_name("manager"), [&] {serv_13_OBJECT_DETECT->kill();});
...
static void waiter()
{
  ...
  while (simgrid::s4u::Engine::get_clock() < 230) {
    auto hList = simgrid::s4u::Engine::get_instance()->get_all_hosts();
    for(auto h : hList) {
      XBT_INFO("load on %s %lf : %lf - %lf", h->get_cname(), sg_host_get_avg_load(h), simgrid::s4u::Engine::get_clock()-5, simgrid::s4u::Engine::get_clock());
